...
class PDU(object):
    ...
    def encode_value(self, type, name, value):
        ...
        if type in [pyagentx.TYPE_INTEGER]:
            ...
            pyagentx.TYPE_COUNTER32,
            pyagentx.TYPE_GAUGE32,
            ...
            pyagentx.TYPE_IPADDRESS,
            pyagentx.TYPE_OPAQUE,
            pyagentx.TYPE_OCTETSTRING,
        ]:
            buf += self.encode_octet(value)
        elif type in [
            pyagentx.TYPE_NULL,
            pyagentx.TYPE_NOSUCHOBJECT,
            pyagentx.TYPE_NOSUCHINSTANCE,
            pyagentx.TYPE_ENDOFMIBVIEW,
        ]:
            # No data
            pass
        else:
